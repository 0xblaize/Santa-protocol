 ...
 */
export const APP_NAME: string = 'Santa Protocol';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'Gift your top engagers, earn holiday points, and fuel the community-led $SANTA launch on Dec 25.';
 ...
 */
export const APP_BUTTON_TEXT: string = '🎁 Open My Gift';
